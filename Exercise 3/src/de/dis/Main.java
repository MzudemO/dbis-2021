...
//                new RunnableOperation(c1, 'w', "UPDATE dissheet3 SET name = 'Jason' WHERE id = 2;"),
//                new RunnableOperation(c1, 'c', "COMMIT;"),
//                new RunnableOperation(c2, 'r', "SELECT name FROM dissheet3 WHERE id = 2;"),
//                new RunnableOperation(c2, 'w', "UPDATE dissheet3 SET name = name || ' + Rose' WHERE id = 1;"),
//                new RunnableOperation(c2, 'w', "UPDATE dissheet3 SET name = name || ' + Jack' WHERE id = 2;"),
//                new RunnableOperation(c2, 'c', "COMMIT;"))
//        );
